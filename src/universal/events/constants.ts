...
export const WINDOW_STATE_CHANGED = 'WINDOW_STATE_CHANGED'
...
export const PICGO_PLUGIN_MENU_ACTION = 'PICGO_PLUGIN_MENU_ACTION'
...
// clipboard
export const CLIPBOARD_WRITE_TEXT = 'CLIPBOARD_WRITE_TEXT'
// i18n
