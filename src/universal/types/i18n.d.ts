...
interface ILocales {
  ...
  PICGO_CLOUD_LAST_SYNC_LABEL: string
  PICGO_CLOUD_PLAN_USAGE_TITLE: string
  PICGO_CLOUD_PLAN_USAGE_DESC: string
  PICGO_CLOUD_PLAN_PERIOD_LABEL: string
  PICGO_CLOUD_STORAGE_LABEL: string
  PICGO_CLOUD_FILES_LABEL: string
  PICGO_CLOUD_USAGE_PROGRESS: string
  PICGO_CLOUD_USAGE_UNLIMITED: string
  PICGO_CLOUD_PLAN_PERIOD_RENEWS: string
  PICGO_CLOUD_PLAN_PERIOD_CANCELS: string
  PICGO_CLOUD_PLAN_PERIOD_UNTIL: string
  PICGO_CLOUD_PLAN_PERIOD_LIFETIME: string
  PICGO_CLOUD_PLAN_PERIOD_GRACE_LABEL: string
  PICGO_CLOUD_PLAN_PERIOD_GRACE_TOOLTIP: string
  PICGO_CLOUD_PLAN_PERIOD_FROZEN_LABEL: string
  PICGO_CLOUD_PLAN_PERIOD_FROZEN_TOOLTIP: string
  PICGO_CLOUD_QUOTA_DOWNGRADED: string
  PICGO_CLOUD_LIFECYCLE_BANNER_GRACE_TITLE: string
  PICGO_CLOUD_LIFECYCLE_BANNER_GRACE_DESC: string
  PICGO_CLOUD_LIFECYCLE_BANNER_FROZEN_TITLE: string
  PICGO_CLOUD_LIFECYCLE_BANNER_FROZEN_DESC: string
  PICGO_CLOUD_LIFECYCLE_BANNER_PENDING_CLEANUP_TITLE: string
  PICGO_CLOUD_LIFECYCLE_BANNER_PENDING_CLEANUP_DESC: string
  PICGO_CLOUD_LIFECYCLE_BANNER_CTA: string
  PICGO_CLOUD_LIFECYCLE_BANNER_DISMISS: string
  PICGO_CLOUD_AUTO_IMPORT_DISABLED_BY_LIFECYCLE: string
  PICGO_CLOUD_IMAGE_UNAVAILABLE: string
  PICGO_CLOUD_ERROR_GRACE_RESTRICTED: string
  PICGO_CLOUD_ERROR_ACCOUNT_FROZEN: string
  PICGO_CLOUD_ERROR_IMPORT_DISABLED: string
  PICGO_CLOUD_ERROR_PLAN_INELIGIBLE: string
  PICGO_CLOUD_ERROR_QUOTA_EXCEEDED_ACTIVE: string
  PICGO_CLOUD_ERROR_QUOTA_EXCEEDED_GRACE: string
  PICGO_CLOUD_ERROR_PLAN_REQUIRED: string
  PICGO_CLOUD_USAGE_LOAD_FAILED: string
  PICGO_CLOUD_CONFIG_SYNC_LOAD_FAILED: string
  PICGO_CLOUD_FREE_PLAN_BANNER: string
  PICGO_CLOUD_VIEW_PLANS: string
  PICGO_CLOUD_CONFIG_SYNC_TITLE: string
  PICGO_CLOUD_CONFIG_SYNC_CARD_DESC: string
  PICGO_CLOUD_SYNC_NOW: string
  PICGO_CLOUD_SYNC_QUOTA_LABEL: string
  PICGO_CLOUD_SYNC_QUOTA_TIP: string
  PICGO_CLOUD_LOGIN_PANEL_TITLE: string
  PICGO_CLOUD_LOGIN_PANEL_DESC: string
  PICGO_CLOUD_LOGIN_FEATURES_TITLE: string
  PICGO_CLOUD_OFFICIAL_IMAGE_HOST_TITLE: string
  PICGO_CLOUD_OFFICIAL_IMAGE_HOST_DESC: string
  PICGO_CLOUD_PAID_PLAN_BADGE: string
  ...
  PLUGIN_DEPRECATED_BADGE: string
  PLUGIN_DEPRECATED_TITLE: string
