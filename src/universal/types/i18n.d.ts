...
interface ILocales {
  ...
  GALLERY_ADD: string
  GALLERY_SOURCE_LOCAL: string
  GALLERY_SOURCE_CLOUD: string
  GALLERY_CLOUD_LOAD_FAILED: string
  GALLERY_CLOUD_LOGIN_REQUIRED_TITLE: string
  GALLERY_CLOUD_LOGIN_REQUIRED_DESC: string
  GALLERY_CLOUD_LOGIN_BUTTON: string
  GALLERY_CLOUD_UPGRADE_TITLE: string
  GALLERY_CLOUD_UPGRADE_DESC: string
  GALLERY_CLOUD_UPGRADE_BUTTON: string
  GALLERY_CLOUD_FEATURES_TITLE: string
  GALLERY_CLOUD_FEATURE_SYNC: string
  GALLERY_CLOUD_FEATURE_AUTO_IMPORT: string
  GALLERY_CLOUD_FEATURE_SECURE: string
  GALLERY_CLOUD_IMPORT_GUIDE_TITLE: string
  GALLERY_CLOUD_IMPORT_GUIDE_DESC: string
  GALLERY_CLOUD_IMPORT_GUIDE_BUTTON: string
  GALLERY_CLOUD_EMPTY_TITLE: string
  GALLERY_CLOUD_EMPTY_DESC: string
  GALLERY_CLOUD_IMPORTING: string
  GALLERY_CLOUD_IMPORT_SUCCESS: string
  GALLERY_CLOUD_IMPORT_FAILED: string
  GALLERY_CLOUD_REFRESH: string
  GALLERY_CLOUD_IMPORT_CONFIRM_TITLE: string
  GALLERY_CLOUD_IMPORT_CONFIRM_DESC: string
  GALLERY_CLOUD_DELETE_FAILED: string
  GALLERY_INSPECTOR_DETAILS_TITLE: string
  GALLERY_INSPECTOR_FILE_NAME: string
  GALLERY_INSPECTOR_UPLOADER: string
  GALLERY_INSPECTOR_CONTENT_TYPE: string
  GALLERY_INSPECTOR_CREATED_AT: string
  GALLERY_INSPECTOR_UPDATED_AT: string
  GALLERY_INSPECTOR_FILE_SIZE: string
  GALLERY_CLOUD_IMPORT_STATUS_TITLE: string
  GALLERY_CLOUD_IMPORTED: string
  GALLERY_CLOUD_IMPORTED_TOOLTIP: string
  GALLERY_CLOUD_REIMPORT: string
  GALLERY_CLOUD_NATIVE: string
  GALLERY_CLOUD_IMPORT_BUTTON: string
  GALLERY_CLOUD_IMPORT_BUTTON_COUNT: string
  GALLERY_CLOUD_ALL_IMPORTED: string
  GALLERY_CLOUD_AUTO_IMPORT_REQUIRED_TITLE: string
  GALLERY_CLOUD_AUTO_IMPORT_REQUIRED_DESC: string
  GALLERY_CLOUD_AUTO_IMPORT_ENABLE_AND_IMPORT: string
  GALLERY_CLOUD_IMPORT_SINGLE_SUCCESS: string
