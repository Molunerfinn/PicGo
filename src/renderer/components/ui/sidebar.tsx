...
type SidebarState = ValueOf<typeof SIDEBAR_STATE>
...
type SidebarSide = ValueOf<typeof SIDEBAR_SIDE>
...
type SidebarVariant = ValueOf<typeof SIDEBAR_VARIANT>

const SIDEBAR_COLLAPSIBLE = {
  OFF_EXAMPLES: "offExamples",
  ICON: "icon",
  NONE: "none",
} as const

type SidebarCollapsible =
  ValueOf<typeof SIDEBAR_COLLAPSIBLE>

const SIDEBAR_MENU_SUB_BUTTON_SIZE = {
  SMALL: "sm",
  MEDIUM: "md",
} as const
...
function Sidebar({
  ...
  collapsible = SIDEBAR_COLLAPSIBLE.OFF_EXAMPLES,
  className,
  children,
  ...props
}: React.ComponentProps<"div"> & {
  ...
  if (collapsible === SIDEBAR_COLLAPSIBLE.NONE) {
    return (
      <div
        data-slot="sidebar"
        className={cn(
    ...
    >
      ...
      <div
        ...
        className={cn(
          ...
          variant === SIDEBAR_VARIANT.FLOATING ||
            variant === SIDEBAR_VARIANT.INSET
...
function SidebarMenuSubButton({
  asChild = false,
  size = SIDEBAR_MENU_SUB_BUTTON_SIZE.MEDIUM,
  isActive = false,
  className,
  ...props
