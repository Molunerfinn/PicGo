  ...
  <div id="picgo-setting">
    ...
    <el-row class="setting-list">
      <el-col :span="16" :offset="4">
        <el-row>
          <el-form label-width="160px" label-position="right" size="small">
            <el-form-item label="打开配置文件">
              <el-button
                type="primary"
                round
                size="mini"
            ...
            <el-form-item label="检查更新">
              <el-button type="primary" round size="mini" @click="checkUpdate"
                >点击检查</el-button
              >
            </el-form-item>
            <el-form-item label="打开更新助手">
              <el-switch
            ...
            <el-form-item v-show="form.updateHelper" label="接受Beta版本更新">
              <el-switch
            ...
            <el-form-item v-if="os !== 'darwin'" label="Mini窗口置顶">
              <el-switch
    ...
    >
      ...
      >
        <el-form-item prop="value">
          <div class="custom-title">用占位符 <b>$url</b> 来表示url的位置</div>
      ...
      <div>如[$fileName]($url)</div>
      <span slot="footer">
        <el-button @click="cancelCustomLink" round>取消</el-button>
        <el-button type="primary" @click="confirmCustomLink" round
          >确定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      ...
      <div>最新版本：{{ latestVersion ? latestVersion : '正在获取中...' }}</div>
      <div v-if="needUpdate">PicGo更新啦，请点击确定打开下载页面</div>
      <span slot="footer">
        <el-button @click="cancelCheckVersion" round>取消</el-button>
        <el-button type="primary" @click="confirmCheckVersion" round
          >确定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      <el-form label-position="right" label-width="100px">
        ...
        <el-form-item label="日志记录等级">
          <el-select v-model="form.logLevel" multiple collapse-tags>
            <el-option
      ...
      <span slot="footer">
        ...
        <el-button type="primary" @click="confirmLogLevelSetting" round
          >确定</el-button
        >
      </span>
    </el-dialog>
    ...
    >
      ...
      <span slot="footer">
        ...
        <el-button type="primary" @click="confirmServerSetting" round
          >确定</el-button
        >
      </span>
    </el-dialog>
...
export default class extends Vue {
  ...
  async initData() {
    ...
    if (config !== undefined) {
      ...
      this.form.autoCopyUrl =
        settings.autoCopy === undefined ? true : settings.autoCopy
      this.form.checkBetaUpdate =
        settings.checkBetaUpdate === undefined ? true : settings.checkBetaUpdate
  ...
  getPicBeds(event: Event, picBeds: IPicBedType[]) {
    this.picBed = picBeds
    this.form.showPicBedList = this.picBed
  ...
  async cancelCustomLink() {
    ...
    this.customLink.value =
      (await this.getConfig<string>('settings.customLink')) || '$url'
  }
